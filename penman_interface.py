...
from penman import interpret as interpret_
...
def interpret(t):
    model = amr_model
    pm_graph = interpret_(t=t, model=model)
    mask_triples = []
    for t in pm_graph.triples:
        mask_triples.append(t) if t[1]!=":<MASK>" else mask_triples.append((t[0], "<MASK>", t[2]))
    pm_graph.triples = mask_triples
    return pm_graph